...
void TFE_OpReset(TFE_Op* op_to_reset,
...
void TFE_MonitoringCounterCellIncrementBy(
...
// error.
TFE_MonitoringCounter0* TFE_MonitoringNewCounter0(
    const char* name, TF_Status* status, const char* description);
// Deletes the Counter object.
void TFE_MonitoringDeleteCounter0(
...
TFE_MonitoringCounter1* TFE_MonitoringNewCounter1(
    const char* name, TF_Status* status, const char* description,
    const char* label1);
void TFE_MonitoringDeleteCounter1(
...
TFE_MonitoringCounter2* TFE_MonitoringNewCounter2(
    const char* name, TF_Status* status, const char* description,
    const char* label1, const char* label2);
void TFE_MonitoringDeleteCounter2(
...
void TFE_MonitoringIntGaugeCellSet(
    TFE_MonitoringIntGaugeCell* cell, int64_t value);

// Retrieves the current value of the cell.
int64_t TFE_MonitoringIntGaugeCellValue(
...
TFE_MonitoringIntGauge0* TFE_MonitoringNewIntGauge0(
    const char* name, TF_Status* out_status, const char* description);
void TFE_MonitoringDeleteIntGauge0(
...
TFE_MonitoringIntGauge1* TFE_MonitoringNewIntGauge1(
    const char* name, TF_Status* out_status, const char* description,
    const char* label1);
void TFE_MonitoringDeleteIntGauge1(
...
TFE_MonitoringIntGauge2* TFE_MonitoringNewIntGauge2(
    const char* name, TF_Status* out_status, const char* description,
    const char* label1, const char* label2);
void TFE_MonitoringDeleteIntGauge2(
...
void TFE_MonitoringStringGaugeCellSet(
...
TFE_MonitoringStringGauge0* TFE_MonitoringNewStringGauge0(
    const char* name, TF_Status* out_status, const char* description);
void TFE_MonitoringDeleteStringGauge0(
...
TFE_MonitoringStringGauge1* TFE_MonitoringNewStringGauge1(
    const char* name, TF_Status* out_status, const char* description,
    const char* label1);
void TFE_MonitoringDeleteStringGauge1(
...
TFE_MonitoringStringGauge2* TFE_MonitoringNewStringGauge2(
    const char* name, TF_Status* out_status, const char* description,
    const char* label1, const char* label2);
void TFE_MonitoringDeleteStringGauge2(
...
void TFE_MonitoringBoolGaugeCellSet(
    TFE_MonitoringBoolGaugeCell* cell, bool value);
bool TFE_MonitoringBoolGaugeCellValue(
...
TFE_MonitoringBoolGauge0* TFE_MonitoringNewBoolGauge0(
    const char* name, TF_Status* out_status, const char* description);
void TFE_MonitoringDeleteBoolGauge0(
...
TFE_MonitoringBoolGauge1* TFE_MonitoringNewBoolGauge1(
    const char* name, TF_Status* out_status, const char* description,
    const char* label1);
void TFE_MonitoringDeleteBoolGauge1(
...
TFE_MonitoringBoolGauge2* TFE_MonitoringNewBoolGauge2(
    const char* name, TF_Status* out_status, const char* description,
    const char* label1, const char* label2);
void TFE_MonitoringDeleteBoolGauge2(
...
TFE_MonitoringNewExponentialBuckets(double scale, double growth_factor,
                                    int bucket_count);
void TFE_MonitoringDeleteBuckets(
...
void TFE_MonitoringDeleteSampler0(
...
void TFE_MonitoringDeleteSampler1(
...
void TFE_MonitoringDeleteSampler2(
...
void TFE_ContextOptionsSetLazyRemoteInputsCopy(
    TFE_ContextOptions* opts, bool lazy_copy);

// Sets whether to use TFRT
void TFE_ContextOptionsSetTfrt(TFE_ContextOptions* opts,
                                                     bool use_tfrt);
...
// execution of `op`.
typedef struct TFE_CancellationManager TFE_CancellationManager;
void TFE_OpSetCancellationManager(
...
void TFE_ExecutorWaitForAllPendingNodes(
    TFE_Executor* executor, TF_Status* status);
...
void TFE_ContextSetExecutorForThread(TFE_Context* ctx,
                                                           TFE_Executor* executor);

// Returns the Executor for current thread.
TFE_Executor* TFE_ContextGetExecutorForThread(
    TFE_Context* ctx);
...
void TFE_ContextUpdateServerDef(TFE_Context* ctx,
                                                      int keep_alive_secs,
                                                      const void* proto,
                                                      size_t proto_len,
                                                      TF_Status* status);
...
bool TFE_ContextCheckAlive(TFE_Context* ctx,
...
// combined status.
void TFE_ContextAsyncWait(TFE_Context* ctx,
                                                TF_Status* status);
...
void* TFE_TensorHandleDevicePointer(TFE_TensorHandle* tensor_handle,
                                                          TF_Status* status);

// This function will block till the operation that produces `h` has
// completed. This is only valid on local TFE_TensorHandles. Returns the size in
// bytes of the memory pointed to by the device pointer returned above.
size_t TFE_TensorHandleDeviceMemorySize(TFE_TensorHandle* tensor_handle,
                                                              TF_Status* status);
...
TFE_TensorHandle* TFE_NewTensorHandleFromDeviceMemory(
    TFE_Context* ctx, const char* device_name, TF_DataType dtype, const int64_t* dims,
...
void TFE_HostAddressSpace(TFE_Context* ctx,
                                                TF_Buffer* buf);
...
void TFE_OpAttrsSerialize(const TFE_OpAttrs* attrs,
                                                TF_Buffer* buf,
                                                TF_Status* status);
...
void TFE_OpSetAttrValueProto(const TFE_Op* op,
...
// is added.
void TFE_RegisterCustomDevice(TFE_Context* ctx,
                                                    TFE_CustomDevice device,
                                                    const char* device_name,
                                                    void* device_info,
                                                    TF_Status* status);

void TFE_ContextGetFunctionDef(TFE_Context* ctx,
...
TF_Tensor* TFE_AllocateHostTensor(TFE_Context* ctx,
                                                        TF_DataType dtype,
                                                        const int64_t* dims,
                                                        int num_dims,
                                                        TF_Status* status);
...
TFE_TensorHandle* TFE_NewTensorHandleFromTensor(
...
// it.
TFE_TensorHandle* TFE_CreatePackedTensorHandle(
