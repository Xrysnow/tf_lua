...
TF_Tensor* TF_NewTensor(
    TF_DataType type, const int64_t* dims, int num_dims, void* data, size_t len,
...
TF_Tensor* TF_AllocateTensor(TF_DataType type,
                                                   const int64_t* dims,
...
size_t TF_TensorByteSize(const TF_Tensor* tensor);
...
// TF_INVALID_ARGUMENT.
void TF_TensorBitcastFrom(const TF_Tensor* from,
