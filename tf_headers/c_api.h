...
TF_Buffer* TF_NewBufferFromString(const void* proto,
                                                        size_t proto_len);
...
// ip:port
// host:port
void TF_SetTarget(TF_SessionOptions* options,
                                        const char* target);
...
void TF_SetConfig(TF_SessionOptions* options,
                                        const void* proto, size_t proto_len,
                                        TF_Status* status);

// Destroy an options object.
void TF_DeleteSessionOptions(TF_SessionOptions* options);
...
void TF_DeleteGraph(TF_Graph* graph);
...
void TF_GraphSetTensorShape(TF_Graph* graph,
                                                  TF_Output output,
                                                  const int64_t* dims,
                                                  const int num_dims,
                                                  TF_Status* status);
...
// Returns an error into `status` if:
//   * `output` is not in `graph`.
int TF_GraphGetTensorNumDims(TF_Graph* graph,
                                                   TF_Output output,
                                                   TF_Status* status);
...
void TF_GraphGetTensorShape(TF_Graph* graph,
                                                  TF_Output output,
...
void TF_SetDevice(TF_OperationDescription* desc,
                                        const char* device);
...
void TF_AddInput(TF_OperationDescription* desc,
                                       TF_Output input);
...
void TF_AddControlInput(TF_OperationDescription* desc,
                                              TF_Operation* input);
...
void TF_ColocateWith(TF_OperationDescription* desc,
                                           TF_Operation* op);
...
int TF_OperationOutputListLength(TF_Operation* oper,
                                                       const char* arg_name,
                                                       TF_Status* status);

int TF_OperationNumInputs(TF_Operation* oper);
TF_DataType TF_OperationInputType(TF_Input oper_in);
int TF_OperationInputListLength(TF_Operation* oper,
                                                      const char* arg_name,
                                                      TF_Status* status);
...
// an operation.
void TF_OperationAllInputs(TF_Operation* oper,
                                                 TF_Output* inputs,
                                                 int max_inputs);
...
int TF_OperationOutputConsumers(TF_Output oper_out,
                                                      TF_Input* consumers,
                                                      int max_consumers);
...
// attr_name)).
void TF_OperationGetAttrString(TF_Operation* oper,
                                                     const char* attr_name,
                                                     void* value,
                                                     size_t max_length,
                                                     TF_Status* status);
...
void TF_OperationGetAttrInt(TF_Operation* oper,
                                                  const char* attr_name,
                                                  int64_t* value,
                                                  TF_Status* status);
...
// attr_name)).
void TF_OperationGetAttrIntList(TF_Operation* oper,
                                                      const char* attr_name,
                                                      int64_t* values,
                                                      int max_values,
                                                      TF_Status* status);

void TF_OperationGetAttrFloat(TF_Operation* oper,
                                                    const char* attr_name,
                                                    float* value,
                                                    TF_Status* status);
...
// attr_name)).
void TF_OperationGetAttrFloatList(TF_Operation* oper,
                                                        const char* attr_name,
                                                        float* values,
                                                        int max_values,
                                                        TF_Status* status);

void TF_OperationGetAttrBool(TF_Operation* oper,
                                                   const char* attr_name,
                                                   unsigned char* value,
                                                   TF_Status* status);
...
// to TF_AttrMetadata.list_size from TF_OperationGetAttrMetadata(oper,
// attr_name)).
void TF_OperationGetAttrBoolList(TF_Operation* oper,
                                                       const char* attr_name,
                                                       unsigned char* values,
                                                       int max_values,
                                                       TF_Status* status);

void TF_OperationGetAttrType(TF_Operation* oper,
                                                   const char* attr_name,
                                                   TF_DataType* value,
                                                   TF_Status* status);
...
// to TF_AttrMetadata.list_size from TF_OperationGetAttrMetadata(oper,
// attr_name)).
void TF_OperationGetAttrTypeList(TF_Operation* oper,
                                                       const char* attr_name,
                                                       TF_DataType* values,
                                                       int max_values,
                                                       TF_Status* status);
...
void TF_OperationGetAttrShape(TF_Operation* oper,
                                                    const char* attr_name,
                                                    int64_t* value,
                                                    int num_dims,
                                                    TF_Status* status);
...
void TF_OperationGetAttrTensor(TF_Operation* oper,
                                                     const char* attr_name,
                                                     TF_Tensor** value,
                                                     TF_Status* status);
...
void TF_OperationGetAttrTensorList(TF_Operation* oper,
                                                         const char* attr_name,
                                                         TF_Tensor** values,
                                                         int max_values,
                                                         TF_Status* status);
...
// }
TF_Operation* TF_GraphNextOperation(TF_Graph* graph,
                                                          size_t* pos);
...
void TF_GraphToGraphDef(TF_Graph* graph,
...
void TF_GraphGetOpDef(TF_Graph* graph,
                                            const char* op_name,
                                            TF_Buffer* output_op_def,
                                            TF_Status* status);

// Returns the serialized VersionDef proto for this graph.
void TF_GraphVersions(TF_Graph* graph,
...
void TF_GraphCopyFunction(TF_Graph* g,
...
int TF_GraphGetFunctions(TF_Graph* g, TF_Function** funcs,
                                               int max_func, TF_Status* status);

// Note: The following function may fail on very large protos in the future.

void TF_OperationToNodeDef(TF_Operation* oper,
...
// TF_NewWhile() call.
void TF_FinishWhile(const TF_WhileParams* params,
                                          TF_Status* status,
                                          TF_Output* outputs);
...
//
//  On failure, null.
TF_Function* TF_FunctionImportFunctionDef(
...
// representing a binary serialization of an AttrValue protocol
// buffer.
void TF_FunctionSetAttrValueProto(TF_Function* func,
                                                        const char* attr_name,
                                                        const void* proto,
                                                        size_t proto_len,
                                                        TF_Status* status);
...
unsigned char TF_TryEvaluateConstant(TF_Graph* graph,
                                                           TF_Output output,
                                                           TF_Tensor** result,
                                                           TF_Status* status);
...
void TF_CloseSession(TF_Session* session, TF_Status* status);
...
// corresponding graph).
void TF_DeleteSession(TF_Session* session, TF_Status* status);
...
void TF_CloseDeprecatedSession(TF_DeprecatedSession* session,
                                                     TF_Status* status);
void TF_DeleteDeprecatedSession(TF_DeprecatedSession* session,
                                                      TF_Status* status);
void TF_Reset(const TF_SessionOptions* opt,
...
void TF_ExtendGraph(TF_DeprecatedSession* session,
                                          const void* proto, size_t proto_len,
                                          TF_Status* status);

// See TF_SessionRun() above.
void TF_Run(TF_DeprecatedSession* session,
                                  const TF_Buffer* run_options,
...
void TF_PRunSetup(TF_DeprecatedSession* session,
...
void TF_PRun(TF_DeprecatedSession* session, const char* handle,
                                   const char** input_names, TF_Tensor** inputs,
                                   int ninputs, const char** output_names,
                                   TF_Tensor** outputs, int noutputs,
                                   const char** target_oper_names, int ntargets,
...
TF_DeviceList* TF_SessionListDevices(TF_Session* session,
                                                           TF_Status* status);
...
// Caller takes ownership of the returned TF_DeviceList* which must eventually
// be freed with a call to TF_DeleteDeviceList.
TF_DeviceList* TF_DeprecatedSessionListDevices(
...
const char* TF_DeviceListName(const TF_DeviceList* list,
                                                    int index,
                                                    TF_Status* status);
...
// If index is out of bounds, an error code will be set in the status object,
// and a null pointer will be returned.
const char* TF_DeviceListType(const TF_DeviceList* list,
                                                    int index,
                                                    TF_Status* status);
...
int64_t TF_DeviceListMemoryBytes(
...
uint64_t TF_DeviceListIncarnation(
    const TF_DeviceList* list, int index, TF_Status* status);
...
TF_Library* TF_LoadLibrary(const char* library_filename,
                                                 TF_Status* status);
...
TF_Buffer* TF_GetAllOpList(void);
...
//  status - Set to OK on success and an appropriate error on failure.
TF_ApiDefMap* TF_NewApiDefMap(TF_Buffer* op_list_buffer,
                                                    TF_Status* status);
...
void TF_ApiDefMapPut(TF_ApiDefMap* api_def_map,
                                           const char* text, size_t text_len,
                                           TF_Status* status);

// Returns a serialized ApiDef protocol buffer for the TensorFlow operation
// named `name`.
TF_Buffer* TF_ApiDefMapGet(TF_ApiDefMap* api_def_map,
                                                 const char* name,
                                                 size_t name_len,
                                                 TF_Status* status);
...
TF_Buffer* TF_GetRegisteredKernelsForOp(
    const char* name, TF_Status* status);

// Update edge, switch input/ output in a node
void TF_UpdateEdge(TF_Graph* graph, TF_Output new_src,
...
TF_Server* TF_NewServer(const void* proto,
                                              size_t proto_len,
                                              TF_Status* status);
...
// void TF_RegisterLogListener(void* listener);
